            ...
            <div class="col-lg-6 mb-4">
                ...
                @foreach (Cart::content() as $product)
                    <div class="row border-top mx-0 py-2">
                        <div class="col"><a class="text-dark" href="{{ route('shop.show', $product->model->id) }}">{{ $product->model->name }}</a></div>
            ...
            <div class="col-lg-6">
                ...
                <form class="formsValidate" action="{{ route('checkout.store') }}" method="POST" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input name="address" value="{{ old('address') }}" type="text" class="form-control form-control-sm" id="inputAddress" required>
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" value="{{ old('email') }}" type="email" class="form-control form-control-sm" id="inputEmail">
                    </div>
                    <div class="form-group">
