            ...
            <div class="col-lg-9">
                @if(Cart::count() > 0)
                            ...
                            @foreach (Cart::content() as $product)
                                <tr>
                                    <td class="text-center">
                                        <a href="{{ route('shop.show', $product->model->id) }}"><img height="100px" src="/img/products/{{ $product->model->image }}" alt="..."></a>
                                    </td>
                                    <td><a class="text-dark" href="{{ route('shop.show', $product->model->id) }}">{{ $product->model->name }}</a></td>
                                    <td class="text-center">
                                        <div class="mb-1">
                    ...
                    <div class="row">
                        <div class="col-auto mr-sm-auto mb-3 mb-sm-0">
                            <a href="{{ route('shop.index') }}" class="btn btn-outline-dark d-inline-block mr-auto">Продолжить покупки</a>
                        </div>
                        <div class="col-auto">
                ...
                @else
                    <div class="my-4">
                        ...
                        <a href="{{ route('shop.index') }}" class="btn btn-outline-dark">Продолжить покупки</a>
                    </div>
                @endif
            </div>
        </div>
